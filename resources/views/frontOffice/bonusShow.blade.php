...
@section('content')
<div class="container pt-2" id="showBonus">
    <div class="row justify-content-center">     
        <div class="col-md-12 col-lg-12 pl-3">
            @if (session('success'))
    ...
    <div id="showBonus" class="row mt-3">
            ...
            <div class="card enCour-b">
                ...
                @else     
                    @foreach ($today as $item)
                        <div class="askIn-p">
                            <div class="img-p">
                                <img src="{{asset('images/balloons.png')}}" alt="" class="my-img ">
                            </div>
                            <div class="txt">
